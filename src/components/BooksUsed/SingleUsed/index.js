...
export default function SingleUsed() {
  ...
  <div class="mx-5 py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
    {/* <!-- Product --> */}
    <div class="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">

      {/* <!-- Product image --> */}

      <div class="lg:row-end-1 lg:col-span-4 bg-gray-100 pl-36">
        {/* <div class="aspect-w-4 aspect-h-3 rounded-lg bg-gray-100 overflow-hidden "> */}
          <img src={singleBookUsed.image} alt="book image" class="object-contain  w-96"/>
        {/* </div> */}
      </div>
      ...
      <div class="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
        <div class="flex flex-col-reverse">
          ...
          <div class="mt-4 border-b border-gray-200 mb-10 pb-5">
            <h1 class="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">{singleBookUsed.title}</h1>

            <h2 id="information-heading" class="sr-only">Product information</h2>
            <p class="text-sm text-gray-500 mt-2">{singleBookUsed.author}</p>
            <p class="text-lg text-gray-900 sm:text-xl mt-4">${singleBookUsed.price} USD</p>
          </div>
        ...
        <p class="text-justify text-gray-500 ">{singleBookUsed.description}</p>
  ...
  <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
    ...
    <Link to={`/booksUsed/${id}/editar`}>
      ...
      <button onClick={() => deleteBookUsed(id)}
        type="button"
        class="w-full bg-[#F2FFE9] border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-[#557C55] hover:bg-[#A6CF98] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
      >
        Delete book
      </button>
...
<>
        ...
        <div class="border-t border-gray-200 mt-10 pt-10">
          ...
          <ul role="list" class="flex items-center space-x-6 mt-4">
            <li>
              <a href="https://www.facebook.com" class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500">
            ...
            <li>
              <a href="https://www.instagram.com" class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500">
            ...
            <li>
              <a href="https://www.twitter.com" class="flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500">
