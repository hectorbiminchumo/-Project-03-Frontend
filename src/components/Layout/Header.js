  ...
  return (
    <>
      <header className="flex flex-wrap">
        <nav className="flex w-screen justify-between bg-orange-100 text-gray-700">
          <div className="w-full xl:px-12 py-6 px-5 flex space-x-12 items-center ">
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <Link className="flex items-center hover:text-gray-900" to="/registro">  
                ...
                <a onClick={() => logoutUser()} href="/"  class="ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-purple-700 hover:to-indigo-700">
										Logout
									</a>
								...
								:
								<>
									<Link to="/registro" class="ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-orange-600 to-red-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-yellow-700 hover:to-yellow-700">
										Sign up
									</Link>
            ...
            <div className="hidden xl:flex items-center text-gray-600 space-x-5 items-center">
              ...
              <Link className="flex items-center hover:text-gray-900" to="/registro">  
                ...
                <span className="absolute flex ml-4 -mt-5">
                  <span className="h-3 w-3 animate-ping absolute inline-flex rounded-full bg-red-500 opacity-75"></span>
